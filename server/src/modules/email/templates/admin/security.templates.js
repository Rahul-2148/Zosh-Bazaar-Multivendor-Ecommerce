      ...
      <tr>
        <td style="padding: 16px 18px;">
          <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #f8fafc; font-family: monospace; font-size: 12px; border-collapse: collapse;">
            <tr><td style="color: #94a3b8; width: 120px; padding: 3px 0;">SEVERITY:</td><td style="color: ${data.severity === "CRITICAL" ? "#ef4444" : "#f59e0b"}; font-weight: bold; padding: 3px 0;">${data.severity}</td></tr>
            <tr><td style="color: #94a3b8; padding: 3px 0;">TIMESTAMP:</td><td style="padding: 3px 0;">${data.timestamp}</td></tr>
            <tr><td style="color: #94a3b8; padding: 3px 0;">MODULE:</td><td style="padding: 3px 0;">${data.moduleName}</td></tr>
            ${data.affectedIds?.length ? `<tr><td style="color: #94a3b8; padding: 3px 0;">AFFECTED IDS:</td><td style="padding: 3px 0;">${data.affectedIds.join(", ")}</td></tr>` : ""}
            <tr><td style="color: #94a3b8; padding: 3px 0;">IMPACT:</td><td style="color: #cbd5e1; padding: 3px 0;">${data.impact}</td></tr>
            <tr><td style="color: #94a3b8; padding: 3px 0;">ACTION:</td><td style="color: #38bdf8; padding: 3px 0;">${data.recommendedAction}</td></tr>
          </table>
        </td>
      </tr>
    </table>
