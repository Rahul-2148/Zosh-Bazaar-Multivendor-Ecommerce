    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" class="otp-box-wrapper" style="margin: 24px 0; width: 100%;">
      <tr>
        <td align="center" style="padding: 0;">
          <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" class="otp-card" style="background-color: #eff6ff; border: 2px solid #93c5fd; border-radius: 14px; text-align: center; max-width: 480px; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.08); border-collapse: separate !important;">
            <tr>
