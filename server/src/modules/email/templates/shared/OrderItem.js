...
export function OrderItem({ item }) {
  ...
  return `
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px; border-bottom: 1px solid ${colors.border}; padding-bottom: 14px;" class="dark-border">
      <tr>
